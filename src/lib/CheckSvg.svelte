<script lang="ts">
    import { fillSVG } from "./svgFunc.ts";
    import { onMount } from "svelte";
    let { check, out = $bindable(false) }: { check: boolean; out: boolean } =
        $props();
    let svg: SVGElement;
...
>
    ...
    <sodipodi:namedview
        ...
        inkscape:zoom="0.60975004"
        inkscape:cx="367.36365"
        inkscape:cy="246.82245"
